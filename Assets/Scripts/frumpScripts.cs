...
public class frumpScripts : MonoBehaviour
{
    ...
    public string Lvl1Option2 = "You know I did some research, very in-depth research and discovered that factories are the problem. " +
        "I discovered this myself. So I’m shutting down our factories. I can do that you know. And I'll be sending our production to Shynah. " +
        "Shynah is very advanced. A very advanced people. Some of the most advanced I've been told. Not only does this help the environment." +
        "It also creates jobs now that people don’t have to work in those terrible factories. ";

    public string Lvl1Option3 = "People do not think “Murca the great” when they hear 2nd place, this is what i’ve always said. " +
        "I promised to make SA number one, and that's what I plan to do. We are getting rid of those 'old' fossil fuels, that's what fossil means. " +
        "And we will be focusing on renewable resources like coal. You know, I made some coal in my fireplace the other day, and this brilliant idea came to me. " +
    ...
    public string Lvl3Option1 = "I've always said, if a business is struggling you should let it die. " +
        "The EUSPS says it will cause issues with the votes if I dont give them money. They are threatening me. " +
    ...
    public string Lvl3Option2 = "People tell me they are worried that Brusha may try and interfere with the elections, but there is no need to panic. " +
        "I asked Bootin myself, a good friend of mine. And he said “No”. And that's good enough for me. He is a very trustable man. ";

    public string Lvl3Option3 = "You know I am very honest and dependable person, some people say the most. " +
        "Just last week a lady came up to me and said, “Mr. Frump, You are very honest.” And I would have to agree with her. " +
    ...
    public string Lvl4Option1 = "I met with Him Ong One and we had a great meeting because we’re all in this together. We want to get this thing solved. It’s been going on for a long time. And we had a great meeting. And it was unexpected. I put out yesterday: Maybe I’ll meet with Chairman Him. And he saw it. Social media. A pretty powerful thing, social media. ";

    public string Lvl4Option2 = "Our new budget calls for — listen to this, you’ll love this, \n 78 F-35s.  \n Stealth, right?  Stealth. They say they’re hard to beat because you can’t see them, literally. I’ve gone to some of the great pilots. I say, “What do you think of the F-35?  How does the enemy do?”  “Well, they have a problem. They can’t see it, sir.”  I mean, that’s pretty much it, right?  We’ve got a lot of them. ";
    ...
    public string Lvl5Option2 = "When it comes to defending Murca, it is not enough to merely have a Murcan presence in space, we must have a Murcan dominance in space. It’s going to be something. So important. ";
                     
    public string Lvl5Option3 = "Amid grave threats to our national security, Murcan superiority in space is absolutely vital. And we're leading, but we're not leading by enough. But very shortly we'll be leading by a lot. ";

    public string PerfectEnding = "By leaving matters to the experts. The country has become a Utopia with Martian Colonies. ";

    public string BadEnding = "Having thought super hard about these questions by clicking all the brains, you have created the perfect hole above the ozone for tanning, saved a third of the population from a global pandemic and have proudly been re-elected. ";

    public string StupidEnding = "You now frolick in the Liberian forest with Dutin and his bear, having not been re-elected. ";

    public string GoodEnding = "Having not fuelled your intelligence, you have heard the advice of your people and not destroyed the country. ";
